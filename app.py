...
nutrients = {
    "Macronutrients": {
        ...
        "Carbs": {"current": 80, "target": 150, "unit": "g"},
        "Fiber": {"current": 25, "target": 30, "unit": "g"},
        "Sodium": {"current": 800, "target": 2500, "unit": "mg"}
    },
    "Micronutrients": {
        "Vitamin C": {"current": 90, "target": 90, "unit": "mg"},
        "Vitamin A": {"current": 700, "target": 900, "unit": "mcg"},
        "Vitamin B12": {"current": 1.2, "target": 2.4, "unit": "mcg"},
        "Vitamin D": {"current": 8500, "target": 4000, "unit": "IU", "note": "(Weekly dose averaged)"},
...
with tab1:
    ...
    with c3:
        ...
        if low_nutrients:
            st.error(f"Low: {', '.join(low_nutrients)}")
        else:
